...
\begin{figure}[H]
\centering
\resizebox{\textwidth}{!}{\input{../uml/use-case-diagram.tex}}
...
\hline
\textbf{Regras de Negócio} & - RN001: Todo reporte deve estar vinculado a um local existente no sistema. \newline - RN002: O reporte deve conter obrigatoriamente um título e uma descrição mínima. \newline - RN003: O sistema deve registrar data, hora e usuário responsável pelo reporte. \newline - RN004: O reporte pode conter evidências (foto ou vídeo), mas estas não são obrigatórias. \newline - RN005: O reporte não pode exceder o limite máximo de caracteres definidos pelo sistema (para título e descrição). \\
\hline
...
\hline
\textbf{Pontos de Inclusão} & N/A \\
\hline
\textbf{Pontos de Extensão} & N/A \\
\hline
\end{longtable}
...
\hline
\textbf{Regras de Negócio} & - RN006: O mapa deve exibir apenas problemas confirmados e devidamente registrados.\newline - RN007: O usuário pode aplicar filtros (categoria, data, status).\newline - RN008: Cada problema deve estar associado a uma localização válida.\newline - RN009: O sistema deve mostrar a data de registro e a situação do problema (pendente, em análise, resolvido).\newline - RN010: Problemas com mais de 1 ano podem ser arquivados, mas ainda disponíveis mediante filtro avançado. \\
\hline
...
\begin{figure}[H]
\centering
\resizebox{\textwidth}{!}{\input{../uml/class-diagram.tex}}
...
\begin{figure}[H]
    \centering
    \resizebox{\textwidth}{!}{\input{../uml/sequencia-reportar-problema.tex}}
...
\begin{figure}[H]
    \centering
    \resizebox{\textwidth}{!}{\input{../uml/sequencia-consultar-mapa.tex}}
...
\begin{figure}[H]
    \centering
    \resizebox{\textwidth}{!}{\input{../uml/sequencia-atualizar-status.tex}}
...
\begin{figure}[H]
\centering
\resizebox{\textwidth}{!}{\input{../uml/system-design-diagram.tex}}
