...
\begin{itemize}
    ...
    \item Disponibilidade do sistema $>$ 99\%
\end{itemize}
...
\textbf{Performance:}
\begin{itemize}
    \item Tempo de resposta da API $<$ 2 segundos
...
\begin{longtable}{|p{1cm}|p{1cm}|p{2cm}|p{8cm}|}
\hline
...
\begin{longtable}{|p{1.2cm}|p{1cm}|p{2cm}|p{7.8cm}|}
\hline
\textbf{ID} & \textbf{Tipo} & \textbf{Prioridade} & \textbf{Descrição do Requisito} \\
\hline
\endfirsthead
...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item Rampas fora de norma ($>$8,33\% inclinação)
        \item Calçadas danificadas ou estreitas ($<$1,20m)
...
\IfFileExists{../imgs/pagina_principal.png}{%
    ...
    \fbox{\parbox[c][3cm][c]{0.8\textwidth}{\centering Imagem \texttt{pagina_principal.png} não encontrada}}
}
...
\IfFileExists{../imgs/area_cliente.png}{%
    ...
    \fbox{\parbox[c][3cm][c]{0.8\textwidth}{\centering Imagem \texttt{area_cliente.png} não encontrada}}
}
...
\IfFileExists{../imgs/selecionar_local.png}{%
    ...
    \fbox{\parbox[c][3cm][c]{0.8\textwidth}{\centering Imagem \texttt{selecionar_local.png} não encontrada}}
}
...
\IfFileExists{../imgs/reportar_tipo.png}{%
    ...
    \fbox{\parbox[c][3cm][c]{0.8\textwidth}{\centering Imagem \texttt{reportar_tipo.png} não encontrada}}
}
...
\IfFileExists{../imgs/reportar_descricao.png}{%
    ...
    \fbox{\parbox[c][3cm][c]{0.8\textwidth}{\centering Imagem \texttt{reportar_descricao.png} não encontrada}}
}
...
\IfFileExists{../imgs/dashboard_geral.png}{%
    ...
    \fbox{\parbox[c][3cm][c]{0.8\textwidth}{\centering Imagem \texttt{dashboard_geral.png} não encontrada}}
}
\caption{Dashboards}
\end{figure}
...
\IfFileExists{../imgs/dashboard_meus.png}{%
    ...
    \fbox{\parbox[c][3cm][c]{0.8\textwidth}{\centering Imagem \texttt{dashboard_meus.png} não encontrada}}
}
...
\IfFileExists{../imgs/dashboard_todos.png}{%
    ...
    \fbox{\parbox[c][3cm][c]{0.8\textwidth}{\centering Imagem \texttt{dashboard_todos.png} não encontrada}}
}
...
\IfFileExists{../imgs/class_diagram.png}{%
    ...
    \fbox{\parbox[c][6cm][c]{\textwidth}{\centering Imagem \texttt{class_diagram.png} não encontrada}}
}
